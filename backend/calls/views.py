...
class CallViewSet(viewsets.ModelViewSet):
    """
    ViewSet for managing call records and analysis.
    """
    ...
    def get_queryset(self):
        ...
        # Filter by sentiment (from CallAnalysis)
        ...
        # Search inside transcript, issue, and keywords
        ...
        if search:
            queryset = queryset.annotate(
                ...
                Q(analysis__main_issue__icontains=search) |  # updated field name
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        # Fields belonging to CallAnalysis
        analysis_fields = {
            'main_issue',
            'sentiment_score',
            'keywords',
    ...
    def download(self, request, pk=None):
        """
        Download the audio file associated with a call.
        """
        call = self.get_object()
    ...
    def positive(self, request):
        """
        List calls with positive sentiment.
        """
    ...
    def neutral(self, request):
        """
        List calls with neutral sentiment.
        """
    ...
    def process(self, request, pk=None):
        ...
        """
        call = self.get_object()
        async_result = analyze_call.delay(str(call.id))  # ensure UUID is passed as string
    ...
    def mark_reviewed(self, request, pk=None):
        """
        Mark a call analysis as reviewed.
        """
        call = self.get_object()
...
class FollowUpViewSet(viewsets.ModelViewSet):
    """
    ViewSet for managing follow-up tasks.
    """
